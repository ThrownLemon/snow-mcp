...
class TestServerCatalog:
    ...
    def test_register_catalog_resources(self):
        ...
        assert len(catalog_tools) > 0, "Expected catalog tools in tool definitions"
    ...
    def test_list_catalog_items_tool(self, mock_list_catalog_items):
        ...
        assert 'list_catalog_items' in self.server.tool_definitions, "list_catalog_items should be in tool definitions"
    ...
    def test_get_catalog_item_tool(self, mock_get_catalog_item):
        ...
        # Verify that the tool is in the tool definitions
        assert 'get_catalog_item' in self.server.tool_definitions, "get_catalog_item should be in tool definitions"
    ...
    def test_list_catalog_categories_tool(self, mock_list_catalog_categories):
        ...
        # Verify that the tool is in the tool definitions
        assert 'list_catalog_categories' in self.server.tool_definitions, "list_catalog_categories should be in tool definitions"
